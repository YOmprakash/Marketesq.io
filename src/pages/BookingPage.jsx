...
const BookingPage = () => {
  ...
  <div className="grid grid-cols-2 gap-4">
    <div className="flex items-center w-full p-3 bg-white rounded-lg md:p-4">
      ...
      <span className="px-2 text-sm font-semibold md:text-lg">{adults}</span>
      <button type="button" onClick={() => updateAdults(1)}>
        <FaCirclePlus />
      </button>
    ...
    <div className="flex items-center w-full p-3 bg-white rounded-lg md:p-4">
      ...
      <span className="px-2 text-sm font-semibold md:text-lg">{children}</span>
      <button type="button" onClick={() => updateChildren(1)}>
        <FaCirclePlus />
      </button>
  ...
  <div className="w-full md:w-auto">
    <button
      type="submit"
      className="flex items-center justify-center w-full py-3 font-semibold text-white transition duration-300 bg-blue-600 rounded-lg hover:bg-blue-700"
    >
      ₹ {amount}
    </button>
  </div>
